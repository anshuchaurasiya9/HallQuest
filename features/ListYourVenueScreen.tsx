          ...
          <div className="space-y-8 md:space-y-12 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="space-y-2 md:space-y-3">
                ...
                <input placeholder="Owner or Manager Name" className="w-full p-4 md:p-6 bg-slate-50/50 rounded-2xl md:rounded-3xl border border-slate-100 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-700 font-bold transition-all text-base md:text-lg" />
              </div>
              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Official Phone</label>
                <input placeholder="+91 (000) 000-0000" className="w-full p-4 md:p-6 bg-slate-50/50 rounded-2xl md:rounded-3xl border border-slate-100 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-700 font-bold transition-all text-base md:text-lg" />
              </div>
              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Business PAN Card</label>
                <input placeholder="10 DIGIT PAN NUMBER" className="w-full p-4 md:p-6 bg-slate-50/50 rounded-2xl md:rounded-3xl border border-slate-100 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-700 font-bold transition-all text-base md:text-lg uppercase" />
              </div>
              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">GSTIN Certificate</label>
                <input placeholder="GST REGISTRATION NUMBER" className="w-full p-4 md:p-6 bg-slate-50/50 rounded-2xl md:rounded-3xl border border-slate-100 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-700 font-bold transition-all text-base md:text-lg uppercase" />
              </div>
            </div>
          </div>
        );
          ...
          <div className="space-y-8 md:space-y-10 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="space-y-2 md:space-y-3 md:col-span-2">
                ...
                <input placeholder="e.g. Royal Imperial Gardens" className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg" />
              </div>
              
              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Primary Category</label>
                <select className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg appearance-none">
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                <input placeholder="Max capacity (e.g. 1500)" className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg" />
              </div>

              <div className="space-y-2 md:space-y-3 md:col-span-2">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Full Street Address</label>
                <textarea rows={2} placeholder="Building No, Street Name, Sector, Near Landmark..." className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg" />
              </div>

              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">City / Town</label>
                <input placeholder="e.g. Mumbai" className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg" />
              </div>

              <div className="space-y-2 md:space-y-3">
                <label className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Pin Code / ZIP</label>
                <input placeholder="6-digit PIN" className="w-full p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-3xl border-2 border-pink-50 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary text-slate-900 font-bold transition-all text-base md:text-lg" />
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-8 md:space-y-12 animate-fadeIn">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm md:text-slate-400 font-medium">Your first impression starts with these photos.</p>
            </div>

            <div 
              onClick={() => fileInputRef.current?.click()}
              className="relative border-2 md:border-4 border-dashed border-indigo-100 rounded-3xl md:rounded-[4rem] p-8 md:p-24 text-center space-y-4 md:space-y-6 hover:bg-indigo-50/30 transition-all cursor-pointer group bg-slate-50/30"
            >
              <input type="file" ref={fileInputRef} multiple accept="image/*" onChange={handleFileChange} className="hidden" />
              <div className="w-16 h-16 md:w-24 md:h-24 bg-white rounded-2xl md:rounded-[2.2rem] flex items-center justify-center text-3xl md:text-4xl mx-auto shadow-xl group-hover:rotate-12 transition-transform">📸</div>
              <div className="space-y-1 md:space-y-2">
                <h3 className="text-xl md:text-2xl font-black text-slate-800 poppins">Upload Venue Photos</h3>
                <p className="text-slate-400 font-medium text-xs md:text-sm">Tap to browse your library. Best result with landscape 16:9 ratio.</p>
              </div>
              <div className="pt-2 md:pt-4">
                <div className="inline-flex bg-indigo-600 text-white px-6 md:px-10 py-3 md:py-4 rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-xs md:text-sm shadow-xl shadow-indigo-200">Select Photos</div>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-center justify-between px-2 md:px-4">
                ...
                {uploadedImages.length > 0 && <button onClick={() => setUploadedImages([])} className="text-[8px] md:text-[10px] font-black text-brand-primary uppercase tracking-widest hover:underline">Clear All</button>}
              </div>
                    ...
                    <div key={i} className="aspect-square bg-slate-50 rounded-2xl md:rounded-[2rem] border-2 border-dashed border-slate-100 flex items-center justify-center relative overflow-hidden group">
                      {image ? (
                        ...
                        <div className="flex flex-col items-center space-y-1 md:space-y-2 opacity-30 group-hover:opacity-60 transition-opacity">
                           ...
                           <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest">Reserved Slot</span>
                        </div>
                      )}
                    </div>
                  );
